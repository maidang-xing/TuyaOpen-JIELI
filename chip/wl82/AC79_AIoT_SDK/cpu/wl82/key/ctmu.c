...
static const u8 ctmu_ch_table[] = {
    ...
    IO_PORTH_01, IO_PORTH_02, IO_PORTH_03, IO_PORTH_04,
};
...
static void touch_ctmu_init(const struct touch_key_port *port, u8 num)
{
    ...
    /* CTMU_CON0 |= (1 << 8); //PRD 2.72ms */

    //振荡器电流配置，值越大，振荡器工作电流越大，振荡频率越高，应该根据芯片外围触摸按键实际的固有电容大小来配置，让振荡器的工作频率在1MHz附近
