...
#include "sdio/sdio_host_init.h"
#include "wifi_connect.h"//wireless_ext
...
|DEV_GET_WIFI_SMP_RESULT         |                 |struct smp_cfg_result         |
...
struct cfg_info {
    ...
    int (*cb)(void *, enum WIFI_EVENT, void *);
    void *net_priv;
